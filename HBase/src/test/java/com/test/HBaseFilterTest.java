...
public class HBaseFilterTest {
    ...
    public void addFileDetails() {
        ...
        HBaseUtil.putRow("FileTable","rowkey1","saveInfo", "creator", "kang");
        HBaseUtil.putRow("FileTable","rowkey1","saveInfo", "createTime", "2019-07-03");
        ...
        HBaseUtil.putRow("FileTable","rowkey2","saveInfo", "creator", "kang");
        HBaseUtil.putRow("FileTable","rowkey2","saveInfo", "createTime", "2019-07-03");
        ...
        HBaseUtil.putRow("FileTable","rowkey3","saveInfo", "creator", "kang");
        HBaseUtil.putRow("FileTable","rowkey3","saveInfo", "createTime", "2019-07-03");
    }
